// Accorder l'entrée de « Commun », et l'envoyer par email.
//
...
Deno.serve(async (req: Request) => {
  ...
  const texte = [
    "Bonjour,",
    "",
    "Votre accès à la page « Commun » est ouvert.",
    "",
  ...
  const envoi = await envoyer(cible, "Votre accès à « Commun » — Gestion de Stockage", texte);
